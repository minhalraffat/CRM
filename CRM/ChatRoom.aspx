<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatRoom.aspx.cs" Inherits="CRM.ChatRoomPage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Mint CRM Chats</title>
...
<body>
    ...
    <div id="container">
        <form id="form1" runat="server">
            ...
            <div id="header">
                <img src="/assets/images/m.png" /></div>
            <div class="content">
                <div id="section">
                    <div id="tabs">
                        <ul>
                            <li><a href="#panel-room">Room</a></li>
                        </ul>
            ...
            <div id="footer">
                <div id="button-panel" class="text_format">
                    ...
                    <span class="color_picker_wrap">
                        <input id="textColor" type="text" value="#000000" /></span>
                    ...
                    <span class="options_btn" style="display: none;">
                        <input type="button" id="fileUploadDialogButton" class="send_file options_btn" title="send file" /></span>


                    <span class="text-icons" style="display: none;">
                        <input type="checkbox" id="checkAlert" /><label for="checkAlert" class="alert"></label>
                    </span>
                    <span id="videoBroadcastButtonContainer" class="options_btn">
                        <input type="button" class="broadcast_video" id="checkVideoBroadcast" title="Broadcast video" /></span>
